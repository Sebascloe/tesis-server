...
def crete_distrito_archivo_endpoint(
    distrito: DistritoCreate, session: Session = Depends(get_session)
):
...
def update_distrito_endpoint(
    distrito_id: int, distrito: DistritoCreate, session: Session = Depends(get_session)
):
